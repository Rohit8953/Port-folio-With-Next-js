        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-8 sm:p-5">
          ...
          <div className="mx-auto">
            <ProfileCard
              ...
              avatarUrl="https://res.cloudinary.com/dti1g8mbd/image/upload/e_background_removal/f_png/v1769538831/nnu08qruuko1ggcv7y8n.jpg"
              miniAvatarUrl="https://res.cloudinary.com/dti1g8mbd/image/upload/e_background_removal/f_png/v1769538831/nnu08qruuko1ggcv7y8n.jpg"
              showUserInfo={true}
              enableTilt={true}
              behindGradient=""
              innerGradient=""
